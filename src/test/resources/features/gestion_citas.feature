Feature: Gestion de citas del taller mecanico
  ...
  #
  # 1. Registrar mantenimiento ligero con otro mecanico
  ...
  # 2. Rechazar cita que inicia a las 11 por mecanico ocupado
  ...
  # 3. Aceptar cita que inicia exactamente a las 12
